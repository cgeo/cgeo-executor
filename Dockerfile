...
RUN mkdir slave
RUN ["android-accept-licenses.sh", "android update sdk --all --no-ui --filter android-19,android-22,addon-google_apis-google-22,addon-google_apis-google-23,sys-img-x86_64-addon-google_apis-google-23"]
